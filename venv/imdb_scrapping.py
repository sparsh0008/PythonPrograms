...
def main():
    try:
        ...
        sheet1.write(0, 4, 'Genre')
        sheet1.write(0, 5, 'Release date')
        sheet1.write(0, 6, 'Rating')
        sheet1.write(0, 7, 'Star Cast')
        sheet1.write(0, 8, 'Country')
        sheet1.write(0, 9, 'Budget')
        sheet1.write(0, 10, 'Gross USA')
        sheet1.write(0, 11, 'Cumulative Worldwide Gross')
        sheet1.write(0, 12, 'Ratio')
        sheet1.write(0, 13, 'Taglines')
        ...
        for movie in movie_list:
            ...
            details = [movie_name, movie_rating, movie_time, movie_year, movie_genre, movie_release_date, movie_rating
